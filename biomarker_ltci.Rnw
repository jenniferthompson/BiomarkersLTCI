...
## For functional outcomes, fit models without biomarker terms to use for LR test - WORK ON THIS
# nobio.adl.3 <- with(mice.mean.3,
#                     glm.nb(adl.totscore.3 ~ rcs(age.enroll, 3) + rcs(charlson.score, 3) + edu +
#                              iqcode.score.e + rcs(stroke.risk, 3) + rcs(mean.benz.cube, 3) +
#                              rcs(mean.op.cube, 3) + rcs(mean.prop.cube, 3) + mean.dex.cube +
#                              mean.hal.cube + adl.e + faq.e + as.numeric(frailty)))
# 
# nobio.adl.12 <- with(mice.mean.12,
#                      glm.nb(adl.totscore.12 ~ rcs(age.enroll, 3) + rcs(charlson.score, 3) + edu +
#                               iqcode.score.e + rcs(stroke.risk, 3) + rcs(mean.benz.cube, 3) +
#                               rcs(mean.op.cube, 3) + rcs(mean.prop.cube, 3) + mean.dex.cube +
#                               mean.hal.cube + adl.e + faq.e + as.numeric(frailty)))
# 
# nobio.del.adl.3 <- with(mice.mean.3,
#                         glm.nb(adl.totscore.3 ~ age.enroll + charlson.score + edu +
#                                  iqcode.score.e + mean.benz.cube + mean.dex.cube + mean.hal.cube +
#                                  mean.op.cube + mean.prop.cube + adl.e + faq.e + del.s.imp +
#                                  rcs(ifngamma.mean.t, 3)))
# 
# nobio.del.adl.12 <- with(mice.mean.12,
#                         glm.nb(adl.totscore.12 ~ age.enroll + charlson.score + edu +
#                                  iqcode.score.e + mean.benz.cube + mean.dex.cube + mean.hal.cube +
#                                  mean.op.cube + mean.prop.cube + adl.e + faq.e + del.s.imp +
#                                  rcs(ifngamma.mean.t, 3)))
# 
# nobio.del.faq.3 <- with(mice.mean.3,
#                         glm.nb(faq.rdscore.3 ~ age.enroll + charlson.score + edu +
#                                  iqcode.score.e + mean.benz.cube + mean.dex.cube + mean.hal.cube +
#                                  mean.op.cube + mean.prop.cube + adl.e + faq.e + del.s.imp +
#                                  rcs(ifngamma.mean.t, 3)))
# 
# nobio.del.faq.12 <- with(mice.mean.12,
#                         glm.nb(faq.rdscore.12 ~ age.enroll + charlson.score + edu +
#                                  iqcode.score.e + mean.benz.cube + mean.dex.cube + mean.hal.cube +
#                                  mean.op.cube + mean.prop.cube + adl.e + faq.e + del.s.imp +
#                                  rcs(il1b.mean.t, 3)))
