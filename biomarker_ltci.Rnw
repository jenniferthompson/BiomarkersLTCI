...
brainmind.oneobs$cog.cohort.3 <- brainmind.oneobs$had.all.biomarkers &
  brainmind.oneobs$id %in% subset(brainmind.fu, fu.period == '3 Month' & has.cog.data)$id
brainmind.oneobs$cog.cohort.12 <- brainmind.oneobs$had.all.biomarkers &
  brainmind.oneobs$id %in% subset(brainmind.fu, fu.period == '12 Month' & has.cog.data)$id
brainmind.oneobs$func.cohort.3 <- brainmind.oneobs$had.all.biomarkers &
  brainmind.oneobs$id %in% subset(brainmind.fu, fu.period == '3 Month' & has.func.data)$id
brainmind.oneobs$func.cohort.12 <- brainmind.oneobs$had.all.biomarkers &
  brainmind.oneobs$id %in% subset(brainmind.fu, fu.period == '12 Month' & has.func.data)$id
