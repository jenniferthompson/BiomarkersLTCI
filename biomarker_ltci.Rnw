...
run.marker.mods <- function(marker){
  ...
  ## Mean vs. RBANS
  mean.rbans3.form <-
    as.formula(make.modform('rbans.global.score.3', paste0(marker, '.mean'), covar.cog))
  mean.rbans.nowt.3 <-
  ...
  mean.rbans12.form <-
    as.formula(make.modform('rbans.global.score.12', paste0(marker, '.mean'), covar.cog))
  mean.rbans.nowt.12 <-
  ...
  ## First vs. RBANS
  first.rbans3.form <-
    as.formula(make.modform('rbans.global.score.3', paste0(marker, '.first'), covar.cog))
  first.rbans.nowt.3 <-
  ...
  first.rbans12.form <-
    as.formula(make.modform('rbans.global.score.12', paste0(marker, '.first'), covar.cog))
  first.rbans.nowt.12 <-
  ...
  ## % change vs. RBANS
  pctchg.rbans3.form <-
    as.formula(make.modform('rbans.global.score.3', paste0(marker, '.pctchg'), covar.cog))
  pctchg.rbans.nowt.3 <-
  ...
  pctchg.rbans12.form <-
    as.formula(make.modform('rbans.global.score.12', paste0(marker, '.pctchg'), covar.cog))
  ...
  ## Mean vs. Trails B
  mean.trailb3.form <-
    as.formula(make.modform('trail.b.tscore.3', paste0(marker, '.mean'), covar.cog))
  mean.trailb.nowt.3 <-
  ...
  mean.trailb12.form <-
    as.formula(make.modform('trail.b.tscore.12', paste0(marker, '.mean'), covar.cog))
  mean.trailb.nowt.12 <-
  ...
  ## First vs. Trails B
  first.trailb3.form <-
    as.formula(make.modform('trail.b.tscore.3', paste0(marker, '.first'), covar.cog))
  first.trailb.nowt.3 <-
  ...
  first.trailb12.form <-
    as.formula(make.modform('trail.b.tscore.12', paste0(marker, '.first'), covar.cog))
  ...
  ## % change vs. Trails B
  pctchg.trailb3.form <-
    as.formula(make.modform('trail.b.tscore.3', paste0(marker, '.pctchg'), covar.cog))
  ...
  pctchg.trailb12.form <-
    as.formula(make.modform('trail.b.tscore.12', paste0(marker, '.pctchg'), covar.cog))
    ...
    mutate(measure.str = ifelse(measure == 'first', 'First',
           ...
           results.str = gsub(' +', ' ',
                              paste0(rndformat(difference),
                                     ...
                                     rndformat(ucl), '); P = ',
                                     formatp(pvalue)))) %>%
    select(measure.str, mod.type, low, high, results.str) %>%
...
outcome using restricted cubic splines.
...
\begin{landscape}
\subsection{CRP}
<<printcrplinearresults, results='asis'>>=
...
<<printifngammalinearresults, results='asis'>>=
...
<<printproteinclinearresults, results='asis'>>=
...
<<printtnfalinearresults, results='asis'>>=
...
\subsection{TNFR1}
<<printtnfr1linearresults, results='asis'>>=
