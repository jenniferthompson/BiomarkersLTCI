...
\subsection{CRP}
\subsubsection{RBANS}
<<printcrprbansresults, results='asis', fig.cap = 'CRP vs. RBANS Global Scores, Models Without Delirium', fig.align = 'center', fig.width = 10, fig.height = 4, fig.pos = '!h'>>=
...
@
<<printcrprbansdelresults, results='asis', fig.cap = 'CRP vs. RBANS Global Scores, Models With Delirium', fig.align = 'center', fig.width = 10, fig.height = 4, fig.pos = '!h'>>=
print(plot.test.results(modlist = crp.del.mods, test = 'rbans', marker = 'crp'))
latex.results(crp.rbans.results, 'CRP', 'RBANS Global Scores, Models With Delirium')
@
\clearpage
