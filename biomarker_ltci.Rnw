...
pctchg.sum.cog.3 <- rowSums(is.na(model.data.cog.3[,gsub('\\.imp', '\\.pctchg', biomarker.vnames)]))
pctchg.sum.cog.12 <-
  rowSums(is.na(model.data.cog.12[,gsub('\\.imp', '\\.pctchg', biomarker.vnames)]))
pctchg.sum.func.3 <-
  rowSums(is.na(model.data.func.3[,gsub('\\.imp', '\\.pctchg', biomarker.vnames)]))
pctchg.sum.func.12 <-
  rowSums(is.na(model.data.func.12[,gsub('\\.imp', '\\.pctchg', biomarker.vnames)]))
