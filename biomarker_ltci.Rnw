...
## Functional outcomes
## Delirium *not* included
covar.func <- "rcs(age.enroll, 3) + rcs(charlson.score, 3) + edu + iqcode.score.e + rcs(stroke.risk, 3) + rcs(mean.benz.cube, 3) + rcs(mean.op.cube, 3) + rcs(mean.prop.cube, 3) + mean.dex.cube + mean.hal.cube + adl.e + faq.e + as.numeric(frailty) + rcs(markervar, 3) | rcs(age.enroll, 3) + rcs(charlson.score, 3) + edu + iqcode.score.e + adl.e + faq.e + as.numeric(frailty) + markervar"

## Delirium included
covar.del.func <- "rcs(age.enroll, 3) + rcs(charlson.score, 3) + edu + iqcode.score.e + rcs(stroke.risk, 3) + rcs(mean.benz.cube, 3) + rcs(mean.op.cube, 3) + rcs(mean.prop.cube, 3) + mean.dex.cube + mean.hal.cube + adl.e + faq.e + as.numeric(frailty) + rcs(del.s.imp, 3) + rcs(markervar, 3) | rcs(age.enroll, 3) + rcs(charlson.score, 3) + edu + iqcode.score.e + adl.e + faq.e + as.numeric(frailty) + rcs(del.s.imp, 3) + markervar"
