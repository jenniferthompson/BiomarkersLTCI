...
calc.ratioci.inflltci <- function(marker,
                                  modlist,
                                  modobj,
                                  marker.adjust = NULL,
                                  markerp.adjust = NULL,
  ...
  ## Data set to use: all patients in cohort at specific time point
...
#### TOMORROW: TEST THIS FUNCTION THOROUGHLY
      ...
      as.data.frame(do.call(rbind,
                            lapply(grep(paste0('\\.', test, '\\.[no]*wt\\.[0-9]+$'),
                                   ...
                                   FUN = function(x){
                                     ...
                                     bio.knots <-
                                       eval(parse(text = paste0('rcspline.eval(',
