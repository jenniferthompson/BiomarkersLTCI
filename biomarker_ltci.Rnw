...
## Functional outcomes
## Delirium *not* included
covar.func <- "age.enroll + charlson.score + edu + iqcode.score.e + mean.benz.cube + mean.op.cube + mean.prop.cube + mean.dex.cube + mean.hal.cube + adl.e + faq.e + rcs(markervar, 3) | age.enroll + adl.e"
covar.func.nobio <- gsub(' + rcs(markervar, 3)', '', covar.func, fixed = TRUE)

## Delirium included
covar.del.func <- "age.enroll + charlson.score + edu + iqcode.score.e + mean.benz.cube + mean.op.cube + mean.prop.cube + mean.dex.cube + mean.hal.cube + adl.e + faq.e + del.s.imp + rcs(markervar, 3) | age.enroll + adl.e"
...
nobio.adl.mf.nowt.3 <- with(mice.mean.3,
                            zeroinfl(formula(paste('adl.totscore.3 ~', covar.func.nobio)),
                                     dist = 'negbin'))
nobio.adl.mf.wt.3 <- with(mice.mean.3,
                          zeroinfl(formula(paste('adl.totscore.3 ~', covar.func.nobio)),
                                   weights = wt.func.3, dist = 'negbin'))
nobio.adl.mf.nowt.12 <- with(mice.mean.12,
                             zeroinfl(formula(paste('adl.totscore.12 ~', covar.func.nobio)),
                                      dist = 'negbin'))
nobio.adl.mf.wt.12 <- with(mice.mean.12,
                           zeroinfl(formula(paste('adl.totscore.12 ~', covar.func.nobio)),
                                    weights = wt.func.12, dist = 'negbin'))
nobio.del.adl.mf.nowt.3 <- with(mice.mean.3,
                                zeroinfl(formula(paste('adl.totscore.3 ~', covar.del.func.nobio)),
                                         dist = 'negbin'))
nobio.del.adl.mf.wt.3 <- with(mice.mean.3,
                              zeroinfl(formula(paste('adl.totscore.3 ~', covar.del.func.nobio)),
                                       weights = wt.func.3, dist = 'negbin'))
nobio.del.adl.mf.nowt.12 <- with(mice.mean.12,
                                 zeroinfl(formula(paste('adl.totscore.12 ~', covar.del.func.nobio)),
                                          dist = 'negbin'))
...
run.marker.mods <- function(marker, cog.covar = covar.cog, func.covar = covar.func){
  ...
  mean.adl.nowt.3 <-
    eval(parse(text = sprintf("with(mice.mean.3, zeroinfl(formula = %s, dist = 'negbin'))",
                              mean.adl3.formula)))
  mean.adl.wt.3 <-
    eval(parse(text = sprintf("with(mice.mean.3, zeroinfl(formula = %s, weights = wt.func.3, dist = 'negbin'))",
                              mean.adl3.formula)))
  ...
  mean.adl.nowt.12 <-
    eval(parse(text = sprintf("with(mice.mean.12, zeroinfl(formula = %s, dist = 'negbin'))",
                              mean.adl12.formula)))
  mean.adl.wt.12 <-
    eval(parse(text = sprintf("with(mice.mean.12, zeroinfl(formula = %s, weights = wt.func.12, dist = 'negbin'))",
                              mean.adl12.formula)))
  ...
  first.adl.nowt.3 <-
    eval(parse(text = sprintf("with(mice.first.3, zeroinfl(formula = %s, dist = 'negbin'))",
                              first.adl3.formula)))
  first.adl.wt.3 <-
    eval(parse(text = sprintf("with(mice.first.3, zeroinfl(formula = %s, weights = wt.func.3, dist = 'negbin'))",
                              first.adl3.formula)))
  ...
  first.adl.nowt.12 <-
    eval(parse(text = sprintf("with(mice.first.12, zeroinfl(formula = %s, dist = 'negbin'))",
                              first.adl12.formula)))
  first.adl.wt.12 <-
    eval(parse(text = sprintf("with(mice.first.12, zeroinfl(formula = %s, weights = wt.func.12, dist = 'negbin'))",
                              first.adl12.formula)))
  ...
  pctchg.adl.nowt.3 <-
    eval(parse(text = sprintf("with(mice.pctchg.3, zeroinfl(formula = %s, dist = 'negbin'))",
                              pctchg.adl3.formula)))
  pctchg.adl.wt.3 <-
    eval(parse(text = sprintf("with(mice.pctchg.3, zeroinfl(formula = %s, weights = wt.func.3, dist = 'negbin'))",
                              pctchg.adl3.formula)))
  ...
  pctchg.adl.wt.12 <-
    eval(parse(text = sprintf("with(mice.pctchg.12, zeroinfl(formula = %s, weights = wt.func.12, dist = 'negbin'))",
                              pctchg.adl12.formula)))
...
All models included the following covariates; all covariates are forced to be linear except for the
biomarkers, which are allowed to have a nonlinear relationship with the outcome using restricted
cubic splines. Mean and first biomarker were transformed by taking the base 10 logarithm, so that
extremely high values did not cause problems with model convergence.
