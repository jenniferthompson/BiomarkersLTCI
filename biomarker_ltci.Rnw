...
areg.weight <- aregImpute(~ age.enroll + charlson.score + I(edu) + I(iqcode.score.e) + stroke.risk +
                            ...
                            mean.modsofa.icu + crp.mean.t + ifngamma.mean.t + il10.mean.t +
...
prob.cohort <- function(cohort.var){
  wtmod <- fit.mult.impute(formula = as.formula(paste(cohort.var,
                             "rcs(age.enroll, 3) + rcs(charlson.score, 3) + edu +
                              ...
                              rcs(proteinc.mean.t, 3) + rcs(tnfa.mean.t, 3) + rcs(tnfr1.mean.t, 3)",
                            sep = ' ~ ')),
                            fitter = lrm,
                            xtrans = areg.weight,
                            data = model.data)
...
always.use <- c('age.enroll', 'charlson.score', 'edu', 'iqcode.score.e', 'stroke.risk',
                'mean.benz.cube', 'mean.op.cube', 'mean.prop.cube', 'mean.dex.cube',
                'mean.hal.cube', 'adl.e', 'faq.e', 'frailty', 'icudays.sevseptic.s',
                'mean.modsofa.icu', 'del.s.imp', 'coma.s.imp', 'vent.los.tot.s', 'adl.totscore.12',
                'adl.totscore.3', 'faq.totscore.12', 'faq.totscore.3', 'rbans.global.score.12',
                'rbans.global.score.3', 'trail.b.tscore.12', 'trail.b.tscore.3')
...
## Create vector that is all 1s; function will replace diagonal and unused biomarker measures with 0s
tmp <- rep(1, ncol(model.data.func.3))
...
mice.mean.3 <- mice(data = model.data.func.3, m = 10, predictorMatrix = mice.predmat.mean, seed = 56)
mice.mean.12 <- mice(data = model.data.func.12, m = 10, predictorMatrix = mice.predmat.mean, seed = 56)
mice.first.3 <- mice(data = model.data.func.3, m = 10, predictorMatrix = mice.predmat.first, seed = 56)
mice.first.12 <- mice(data = model.data.func.12, m = 10, predictorMatrix = mice.predmat.first, seed = 56)
mice.pctchg.3 <- mice(data = model.data.func.3, m = 10, predictorMatrix = mice.predmat.pctchg, seed = 56)
mice.pctchg.12 <- mice(data = model.data.func.12, m = 10, predictorMatrix = mice.predmat.pctchg, seed = 56)
...
## Delirium included
covar.del.func <- "rcs(age.enroll, 3) + rcs(charlson.score, 3) + rcs(edu, 3) + rcs(iqcode.score.e, 3) + rcs(stroke.risk, 3) + rcs(mean.benz.cube, 3) + rcs(mean.op.cube, 3) + rcs(mean.prop.cube, 3) + mean.dex.cube + mean.hal.cube + adl.e + faq.e + as.numeric(frailty) + rcs(del.s.imp, 3) + rcs(markervar, 3)"
...
run.marker.mods <- function(marker, cog.covar = covar.cog, func.covar = covar.func, transmethod = NULL){
...
#   ## ADL score ##
#   ## Mean vs. ADL score
#   mean.adl3.form <- as.formula(make.modform('adl.totscore.3', transmarker.mean, func.covar))
#   mean.adl.nowt.3 <-
...
# 
#   mean.adl12.form <- as.formula(make.modform('adl.totscore.12', transmarker.mean, func.covar))
#   mean.adl.nowt.12 <-
...
# 
#   ## First vs. ADL
#   first.adl3.form <- as.formula(make.modform('adl.totscore.3', transmarker.first, func.covar))
#   first.adl.nowt.3 <-
...
#                     data = model.data.func.3)
# 
#   first.adl12.form <- as.formula(make.modform('adl.totscore.12', transmarker.first, func.covar))
#   first.adl.nowt.12 <-
...
# 
#   ## % change vs. ADL
#   pctchg.adl3.form <- as.formula(make.modform('adl.totscore.3', transmarker.pctchg, func.covar))
#   pctchg.adl.nowt.3 <-
...
#                     data = model.data.func.3)
# 
#   pctchg.adl12.form <- as.formula(make.modform('adl.totscore.12', transmarker.pctchg, func.covar))
#   pctchg.adl.nowt.12 <-
...
#   ## FAQ score ##
#   ## Mean vs. FAQ score
#   mean.faq3.form <- as.formula(make.modform('faq.totscore.3', transmarker.mean, func.covar))
#   mean.faq.nowt.3 <-
...
#                     data = model.data.func.3)
# 
#   mean.faq12.form <- as.formula(make.modform('faq.totscore.12', transmarker.mean, func.covar))
#   mean.faq.nowt.12 <-
...
# 
#   ## First vs. FAQ
#   first.faq3.form <- as.formula(make.modform('faq.totscore.3', transmarker.first, func.covar))
#   first.faq.nowt.3 <-
...
#                     data = model.data.func.3)
# 
#   first.faq12.form <- as.formula(make.modform('faq.totscore.12', transmarker.first, func.covar))
#   first.faq.nowt.12 <-
...
# 
#   ## % change vs. FAQ
#   pctchg.faq3.form <- as.formula(make.modform('faq.totscore.3', transmarker.pctchg, func.covar))
#   pctchg.faq.nowt.3 <-
...
#                     data = model.data.func.3)
# 
#   pctchg.faq12.form <- as.formula(make.modform('faq.totscore.12', transmarker.pctchg, func.covar))
#   pctchg.faq.nowt.12 <-
...
crp.mods <- run.marker.mods('crp', transmethod = transtype)
ifngamma.mods <- run.marker.mods('ifngamma', transmethod = transtype)
il10.mods <- run.marker.mods('il10', transmethod = transtype)
il12.mods <- run.marker.mods('il12', transmethod = transtype)
il1b.mods <- run.marker.mods('il1b', transmethod = transtype)
il6.mods <- run.marker.mods('il6', transmethod = transtype)
il8.mods <- run.marker.mods('il8', transmethod = transtype)
mmp9.mods <- run.marker.mods('mmp9', transmethod = transtype)
proteinc.mods <- run.marker.mods('proteinc', transmethod = transtype)
tnfa.mods <- run.marker.mods('tnfa', transmethod = transtype)
tnfr1.mods <- run.marker.mods('tnfr1', transmethod = transtype)

## Models with delirium
crp.del.mods <- run.marker.mods('crp', cog.covar = covar.del.cog,
                                func.covar = covar.del.func, transmethod = transtype)
ifngamma.del.mods <- run.marker.mods('ifngamma', cog.covar = covar.del.cog,
                                     func.covar = covar.del.func, transmethod = transtype)
il10.del.mods <- run.marker.mods('il10', cog.covar = covar.del.cog,
                                 func.covar = covar.del.func, transmethod = transtype)
il12.del.mods <- run.marker.mods('il12', cog.covar = covar.del.cog,
                                 func.covar = covar.del.func, transmethod = transtype)
il1b.del.mods <- run.marker.mods('il1b', cog.covar = covar.del.cog,
                                 func.covar = covar.del.func, transmethod = transtype)
il6.del.mods <- run.marker.mods('il6', cog.covar = covar.del.cog,
                                func.covar = covar.del.func, transmethod = transtype)
il8.del.mods <- run.marker.mods('il8', cog.covar = covar.del.cog,
                                func.covar = covar.del.func, transmethod = transtype)
mmp9.del.mods <- run.marker.mods('mmp9', cog.covar = covar.del.cog,
                                 func.covar = covar.del.func, transmethod = transtype)
proteinc.del.mods <- run.marker.mods('proteinc', cog.covar = covar.del.cog,
                                     func.covar = covar.del.func, transmethod = transtype)
tnfa.del.mods <- run.marker.mods('tnfa', cog.covar = covar.del.cog,
                                 func.covar = covar.del.func, transmethod = transtype)
tnfr1.del.mods <- run.marker.mods('tnfr1', cog.covar = covar.del.cog,
                                  func.covar = covar.del.func, transmethod = transtype)
...
plot.test.results <- function(modlist, ## List of model objects (eg, crp.mods)
                              ...
                              xlab.addon = NULL){ ## Text to add on to X label (eg, "Models Without Delirium")
...
multiplot(plot.test.results(modlist = crp.mods,
                            test = 'rbans',
                            marker = 'crp',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = crp.del.mods,
                            test = 'rbans',
                            marker = 'crp',
...
\clearpage
<<printifngammarbansplots, results='asis', fig.cap = 'ifngamma vs. RBANS Global Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = ifngamma.mods,
                            test = 'rbans',
                            marker = 'ifngamma',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = ifngamma.del.mods,
                            test = 'rbans',
                            marker = 'ifngamma',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
...
\clearpage
<<printifngammatrailbplots, results='asis', fig.cap = 'ifngamma vs. Trails B T-Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = ifngamma.mods,
                            test = 'trailb',
                            marker = 'ifngamma',
                            xlab.addon = 'Models Without Delirium'),
...
\clearpage
<<printil10rbansplots, results='asis', fig.cap = 'il10 vs. RBANS Global Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = il10.mods,
                            test = 'rbans',
                            marker = 'il10',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = il10.del.mods,
                            test = 'rbans',
                            marker = 'il10',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
...
\clearpage
<<printil10trailbplots, results='asis', fig.cap = 'il10 vs. Trails B T-Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = il10.mods,
                            test = 'trailb',
                            marker = 'il10',
                            xlab.addon = 'Models Without Delirium'),
...
\clearpage
<<printil12rbansplots, results='asis', fig.cap = 'il12 vs. RBANS Global Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = il12.mods,
                            test = 'rbans',
                            marker = 'il12',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = il12.del.mods,
                            test = 'rbans',
                            marker = 'il12',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
...
\clearpage
<<printil12trailbplots, results='asis', fig.cap = 'il12 vs. Trails B T-Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = il12.mods,
                            test = 'trailb',
                            marker = 'il12',
                            xlab.addon = 'Models Without Delirium'),
...
multiplot(plot.test.results(modlist = il1b.mods,
                            test = 'rbans',
                            marker = 'il1b',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = il1b.del.mods,
                            test = 'rbans',
                            marker = 'il1b',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
...
\clearpage
<<printil6rbansplots, results='asis', fig.cap = 'il6 vs. RBANS Global Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = il6.mods,
                            test = 'rbans',
                            marker = 'il6',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = il6.del.mods,
                            test = 'rbans',
                            marker = 'il6',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
...
\clearpage
<<printil6trailbplots, results='asis', fig.cap = 'il6 vs. Trails B T-Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = il6.mods,
                            test = 'trailb',
                            marker = 'il6',
                            xlab.addon = 'Models Without Delirium'),
...
\clearpage
<<printil8rbansplots, results='asis', fig.cap = 'il8 vs. RBANS Global Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = il8.mods,
                            test = 'rbans',
                            marker = 'il8',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = il8.del.mods,
                            test = 'rbans',
                            marker = 'il8',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
...
\clearpage
<<printil8trailbplots, results='asis', fig.cap = 'il8 vs. Trails B T-Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = il8.mods,
                            test = 'trailb',
                            marker = 'il8',
                            xlab.addon = 'Models Without Delirium'),
...
multiplot(plot.test.results(modlist = mmp9.mods,
                            test = 'rbans',
                            marker = 'mmp9',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = mmp9.del.mods,
                            test = 'rbans',
                            marker = 'mmp9',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
...
\clearpage
<<printproteincrbansplots, results='asis', fig.cap = 'proteinc vs. RBANS Global Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = proteinc.mods,
                            test = 'rbans',
                            marker = 'proteinc',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = proteinc.del.mods,
                            test = 'rbans',
                            marker = 'proteinc',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
...
\clearpage
<<printproteinctrailbplots, results='asis', fig.cap = 'proteinc vs. Trails B T-Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = proteinc.mods,
                            test = 'trailb',
                            marker = 'proteinc',
                            xlab.addon = 'Models Without Delirium'),
...
\clearpage
<<printtnfarbansplots, results='asis', fig.cap = 'tnfa vs. RBANS Global Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = tnfa.mods,
                            test = 'rbans',
                            marker = 'tnfa',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = tnfa.del.mods,
                            test = 'rbans',
                            marker = 'tnfa',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
...
\clearpage
<<printtnfatrailbplots, results='asis', fig.cap = 'tnfa vs. Trails B T-Scores', fig.align = 'center', fig.width = 10, fig.height = 7.5, fig.pos = '!h'>>=
multiplot(plot.test.results(modlist = tnfa.mods,
                            test = 'trailb',
                            marker = 'tnfa',
                            xlab.addon = 'Models Without Delirium'),
...
multiplot(plot.test.results(modlist = tnfr1.mods,
                            test = 'rbans',
                            marker = 'tnfr1',
                            xlab.addon = 'Models Without Delirium'),
          plot.test.results(modlist = tnfr1.del.mods,
                            test = 'rbans',
                            marker = 'tnfr1',
                            xlab.addon = 'Models With Delirium'),
          layout = matrix(1:2, ncol = 1))
